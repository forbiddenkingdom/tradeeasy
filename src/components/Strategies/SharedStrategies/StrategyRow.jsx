  ...
  return (
    <>
      ...
      <Box
        ...
        alignItems="center"
      >
        <Box component="td" display="flex" alignItems="center" width="17%">
        ...
        <Box component="td" display="flex" width="17%" justifyContent="center">
        ...
        >
          <Typography component="p" className={classes.cellText}>
            {moment(shareDate).format("DD.MM.YYYY")}
          </Typography>
          {menuAnchor && (
            <PopUpMenu id={id} anchor={menuAnchor} handleClose={handleClose} />
          )}
          {!expanded && (
            <IconButton
              aria-label="more"
      ...
      <Box component="tr" display={expanded ? "flex" : "none"} width="100%">
        ...
        >
          ...
          <Box
            ...
            className={classes.expandComponent}
          >
            <img src={image} width="auto" alt="Balance chart" />
            <Operations
              wining={operations.trades_win}
              losing={operations.trades_loss}
              gains={operations.gains_only}
          ...
          >
            ...
            >
              <PrimaryButton>{t("OpenBuilder")}</PrimaryButton>
            </ProtectedComponent>
            <ProtectedComponent
              iconTop="-30px"
              iconRight="2px"
            ...
            >
              <PrimaryButton>{t("OpenValidator")}</PrimaryButton>
            </ProtectedComponent>
          </Box>
        </Box>
      </Box>
