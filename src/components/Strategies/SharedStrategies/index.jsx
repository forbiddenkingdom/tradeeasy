...
const headerCells = [
  ...
  { id: "creator", label: "strategyTable.creator" },
  {
    id: "lastEdit",
...
// Main Component
export default function SharedStrategiesTable({ strategies = [] }) {
  // Hooks
          ...
          .map((strategy) => {
            return (
              <StrategyRow
                ...
                owner={strategy.user && strategy.user.name}
...
// Prop Types
SharedStrategiesTable.propTypes = {
