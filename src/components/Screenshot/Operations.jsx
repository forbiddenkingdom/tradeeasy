...
export default function ScreenshotOperations({
  currency = "",
  wining = 0,
  losing = 0,
  gains = 0,
  ...
  //Main return
  return (
    <Box width="100%" bgcolor="#fff" className={classes.container}>
      <Box
        width="100%"
        display="flex"
        flexDirection="column"
          ...
          >
            ...
            >
              <DonutChart
                palette={["#11CC9A", "#E20E7C"]}
                data={[
                  { asset: "Win", count: gains },
                  { asset: "Losing", count: loses },
                ]}
              />
              <Box
                position="absolute"
...
ScreenshotOperations.propTypes = {
